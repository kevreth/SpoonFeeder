import type { ISummaryLine } from '../../quiz/index';
import { ScoreProcessor } from '../score/scoreProcessor';
import { SummaryLine } from '../score/summaryLine';
import type { AnswerType, Course, SlideInterface } from '../index';

...
// Extended (partial-credit) multiple response: same "select N of M" shape as
// Ma, but paired with Evaluate.PARTIAL/Result.PARTIAL instead of
// Evaluate.SIMPLE/Result.SIMPLE (see factoryEma.ts) so a response earns
// fractional credit instead of an all-or-nothing match.
export class Ema extends Slide implements SlideType {

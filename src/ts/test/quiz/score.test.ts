...
it('quickSummary',() => {
   ...
   module_0.name="module_0";
   module_1.name="module_1";
   module_2.name="module_2";
   module_3.name="module_3";
   lesson_0.name="lesson_0";
   lesson_1.name="lesson_1";
   unit_0.name="unit_0";
   unit_1.name="unit_1";
   course.name="course";
   module_0.complete = 1;
   ...
   unit_0.children=new Array<ISummaryLine>();
   unit_1.children=new Array<ISummaryLine>();
   course.children=new Array<ISummaryLine>();
   ...
   unit_0.children.push(lesson_0);
   unit_1.children.push(lesson_1);
   course.children.push(unit_0);
   course.children.push(unit_1);
   ...
   expect(quickSummary).toHaveLength(4);
   expect(quickSummary[0].name).toEqual('course');
   expect(quickSummary[1].name).toEqual('unit_0');
   expect(quickSummary[2].name).toEqual('lesson_0');
   expect(quickSummary[3].name).toEqual('module_0');
});
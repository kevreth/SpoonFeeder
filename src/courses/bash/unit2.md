...
1. Only one option requiring an argument may be used
1. The option requiring an argument must be last
...
1. refers to the current directory. we may use it in certain circumstances, such as executing a program EXAMPLES
